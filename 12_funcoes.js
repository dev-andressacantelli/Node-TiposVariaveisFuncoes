...
//1° passo -> declarar a função

//ação   nome da funcção (parâmetro)
function imprimeTexto(texto) {
    console.log(texto)
}

//2° passo -> executar a função

imprimeTexto("oi");
imprimeTexto("Outro texto");


//Função com números, exemplo simples
...
//Função com números, exemplo mais elaborado
const n1 = 10
const n2 = 20
const soma = n1 + n2 
...
//imprimeTexto transformou o parametro (texto) em função somaNumero(), retornando o resultado da soma.
